...
def compute_probabilistic_metrics(
    ...
    """
    Inspired by compute_metrics for performance metrics.
    Evaluates quality of probabilities by calculating:
        - class-conditional voxel-wise calibration (foreground classes only : class r) -> on gt_mask : answers whether uncertainty is well calibrated in tumor area
        - global voxel-wise calibration (foreground + background class) -> are overall probabilities well calibrated.
    Function:
        - loads GT
